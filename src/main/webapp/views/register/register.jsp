...
<body>
      <form id="register_form" action="/register/response" method="post">
        ...
        <div class="register_div2">
            <p>추가 정보 입력</p>
            <input type="text" id="nickname" name="u_name" placeholder="닉네임을 입력해주세요.">
            <input type="text" id="birth" name="u_birth" placeholder="생년월일을 입력해주세요 ex) 2005-10-21">
            <input type="text" id="desc" name="u_why" placeholder="맨체스터 시티 팬이 된 이유가 무엇인가요?">
            <div class="buttons">
